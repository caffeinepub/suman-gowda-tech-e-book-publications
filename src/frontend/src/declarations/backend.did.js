...
export const idlService = IDL.Service({
  ...
  'createOrder' : IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Nat], [], []),
  ...
  'getAlleBooks' : IDL.Func([], [IDL.Vec(eBook)], ['query']),
  'getBusinessEmail' : IDL.Func([], [IDL.Text], ['query']),
  ...
  'geteBook' : IDL.Func([IDL.Text], [IDL.Opt(eBook)], ['query']),
  ...
  'submitNewsletter' : IDL.Func([IDL.Text], [], []),
  'transform' : IDL.Func(
      [TransformationInput],
      [TransformationOutput],
      ['query'],
    ),
  'updateBusinessEmail' : IDL.Func([IDL.Text], [], []),
  'updateOrderStatus' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'updateseBookAsset' : IDL.Func([IDL.Text, IDL.Text, ExternalBlob], [], []),
});
